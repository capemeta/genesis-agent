...
func TestDefaultProfileMatchesCurrentDesktopAssembly(t *testing.T) {
	...
	for _, required := range []string{"current_time", "calculator", "http_request", "todo_read", "todo_write", "todo_update_step", "enter_plan_mode", "exit_plan_mode", "write_implementation_plan", "view_image", "Task", "TaskOutput", "TaskStop"} {
